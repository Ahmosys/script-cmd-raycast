...
# Arguments:
# @raycast.argument1 { "type": "dropdown", "placeholder": "Preset or Color", "optional": true, "data": [{"title": "Relax", "value": "preset_relax"}, {"title": "Focus", "value": "preset_focus"}, {"title": "White", "value": "white"}, {"title": "Red", "value": "red"}, {"title": "Cozy", "value": "cozy"}] }
...
PRESETS = {
    "preset_relax": {"color": "cozy", "brightness": 30},
    "preset_focus": {"color": "white", "brightness": 100}
}
...
def set_light_color_and_brightness(bulb: Bulb, color: str, brightness: int):
...
if __name__ == "__main__":
    ...
    choice, brightness_choice = parse_arguments()

    # Check if the choice is a preset
    if choice in PRESETS:
        preset = PRESETS[choice]
        color_choice = preset["color"]
        brightness_choice = preset["brightness"]
    else:
        color_choice = choice
